...
- `"copyRevision":3` and `"consoleHere":true`: the live site has this release.
...
## 12. Republish. This is the step that delivers the release.
...
Required: `"copyRevision":3`, `"consoleHere":true`, and `live console signin
200`.
